...
export const COMEDIC_PROFILES = {
  ...
  buford: {
    ...
    avoid: "No meanness toward people or any group; never insult the owner, only the vehicle; never rush the punchline; the warmth is real — never mock the South or rural folks as the joke.",
  },
  gord: {
    comedicIdentity:
    ...
    avoid: "No personal attacks on the owner or any group; mock the car, not the person; never drop the painfully-nice apologetic warmth — the apology IS the joke.",
  },
};
